...
// Function AkAudio.AkComponent.PostAkEventByName_Forwarder
...
int32 UAkComponent::PostAkEventByName_Forwarder(class UAkAudioEvent* AkEvent, const class FString& in_EventName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AkComponent", "PostAkEventByName_Forwarder");

	Params::AkComponent_PostAkEventByName_Forwarder Parms{};
...
// const class FString&                    EventName                                              (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString&                    EarlyReflectionsBusName                                (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function AkAudio.AkGameplayStatics.UnloadBank_D9
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UAkAudioBank*                     Bank                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString&                    BankName                                               (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAkGameplayStatics::UnloadBank_D9(class UAkAudioBank* Bank, const class FString& BankName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "UnloadBank_D9");

	Params::AkGameplayStatics_UnloadBank_D9 Parms{};
