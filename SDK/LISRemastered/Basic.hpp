...
namespace Offsets
{
	constexpr int32 GObjects          = 0x035A3908;
	constexpr int32 AppendString      = 0x008C72B0;
	constexpr int32 GNames            = 0x0358C380;
	constexpr int32 GWorld            = 0x036B6070;
	constexpr int32 ProcessEvent      = 0x00A51940;
