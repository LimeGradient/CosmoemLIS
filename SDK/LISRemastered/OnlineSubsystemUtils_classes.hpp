...
public:
	...
	class UNetDriver*                             NetDriver;                                         // 0x02D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x02F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x0300(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_309[0x3F];                                     // 0x0309(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x0300(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x02D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x02E0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x02F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class USpectatorBeaconState*                  State;                                             // 0x02F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2F8[0x60];                                     // 0x02F8(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0358(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_359[0x3];                                      // 0x0359(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SessionTimeoutSecs;                                // 0x035C(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
